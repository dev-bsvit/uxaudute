...
import { Sparkles, Brain, BarChart3, CheckCircle } from 'lucide-react'
...
export function AnalysisProgress({ screenshot, url }: AnalysisProgressProps) {
        ...
        <CardContent className="p-8">
          ...
          <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
            <div className="text-sm text-slate-600 text-center">
              ...
              <p>Пожалуйста, не закрывайте эту страницу до завершения анализа</p>
            </div>
          </div>
        </CardContent>
      </Card>
