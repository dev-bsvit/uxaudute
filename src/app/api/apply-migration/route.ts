...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔧 Применяем миграцию для автоматического назначения кредитов...')
    ...
    return NextResponse.json({
      success: true,
      message: 'Миграция применена успешно. Новые пользователи будут получать 5 кредитов автоматически.'
    })
