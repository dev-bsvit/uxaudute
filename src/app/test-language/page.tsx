  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="mb-2">useLocale(): <strong>{locale}</strong></p>
        <p className="mb-2">URL локаль: <strong>{urlLocale || 'не определена'}</strong></p>
        <p className="mb-4">Фактическая локаль: <strong>{actualLocale}</strong></p>
        <div className="mb-4">
          <LanguageSelect />
        </div>
