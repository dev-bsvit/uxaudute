...
import { getSurvey, updateSurvey, publishSurvey, getSurveyResponses } from '@/lib/database'
import { useTranslation } from '@/hooks/use-translation'
import { User } from '@supabase/supabase-js'
import type { Survey, SurveyQuestionInstance, QuestionType, SurveyResponse } from '@/types/survey'
...
export default function SurveyEditorPage() {
  ...
  useEffect(() => {
    if (activeTab === 'results' && survey && responses.length === 0) {
      loadResponses()
    }
  }, [activeTab, survey])
