...
7. Используй "metadata" НЕ "'metadata'" или "{metadata}"
8. Используй "selfCheck" НЕ "'selfCheck'"
9. Строки в двойных кавычках: "gpt-4o" НЕ "'gpt-4o'"
10. Булевы значения: true НЕ "true"
11. Числа: 85 НЕ "85"
12. Все строки должны быть в кавычках, числа без кавычек
13. Массивы в квадратных скобках [], объекты в фигурных скобках {}
14. Генерируй ОБЯЗАТЕЛЬНО 4-5 проблем в problemsAndSolutions со ВСЕМИ полями заполненными**
