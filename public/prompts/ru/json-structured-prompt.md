...
3. **⚠️ КРИТИЧЕСКИ ВАЖНО - АНАЛИЗИРУЙ ТОЛЬКО РЕАЛЬНЫЙ СКРИНШОТ:**
   ...
   **ЗАПРЕЩЁННЫЕ ШАБЛОННЫЕ ФРАЗЫ (НЕ ИСПОЛЬЗУЙ!):**
   - ❌ "Низкая видимость CTA кнопки" - если кнопка ЯРКАЯ и КОНТРАСТНАЯ
   - ❌ "Увеличить контраст кнопки" - если кнопка уже синяя на белом фоне
   - ❌ "Кнопка недостаточно выделена" - если она занимает всю ширину и яркого цвета
   - ❌ "Маленький размер кнопки" - если кнопка крупная и заметная
