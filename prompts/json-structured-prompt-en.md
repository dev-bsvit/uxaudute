...
7. Используй response_format: {"type": "json_object"} для корректного JSON вывода
8. Все строки должны быть в кавычках, числа без кавычек
9. Массивы в квадратных скобках [], объекты в фигурных скобках {}**
